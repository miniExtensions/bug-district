...
var dispatchTestSucceededEvent = function () {
  return __awaiter(void 0, void 0, void 0, function () {
...
var dispatchTestActionSuccessMessage = function (nextActionIndex) {
  return __awaiter(void 0, void 0, void 0, function () {
    var message, parentWindow;
    return __generator(this, function (_a) {
      message = {
...
var dispatchTestActionStoppedMessage = function (actionIndex) {
  return __awaiter(void 0, void 0, void 0, function () {
    var message, parentWindow;
    return __generator(this, function (_a) {
      message = {
...
var dispatchMessageToSetGlobalsOnLastRun = function (args) {
  return __awaiter(void 0, void 0, void 0, function () {
    var message, parentWindow;
    return __generator(this, function (_a) {
      message = {
  ...
  if (
    ...
    var failAtCurrentAction_1 = function (errorMessage) {
      ...
      dispatchActionSetMostRecentTestState_1({
        state: __assign(__assign({}, currentRunningTestState), {
          status: newStatus,
        }),
      });
    ...
    var dispatchActionSetMostRecentTestState_1 = function (args) {
      return __awaiter(void 0, void 0, void 0, function () {
        var message, parentWindow;
        return __generator(this, function (_a) {
          ...
          if (parentWindow) {
            ...
            throw new Error(
              "Could not find a parent window to post message to."
            );
          }
          return [2 /*return*/];
        });
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                delayBetweenActionsInMS = e.data.delayBetweenActionsInMS;
              ...
              case 2:
                if (e.data.type === "did-recieve-available-actions") {
                  currentRunningTestState = e.data.mostRecentState;
                  globalState_1.parentWindowRecievedAvailableAction = true;
                  dispatchActionSetMostRecentTestState_1({
                    state: currentRunningTestState,
                  });
                  if (
                    globalState_1.currentRunningTestState &&
                    globalState_1.currentRunningTestState.status.type ===
                      "running"
                  ) {
                    processNextAction_1();
                  }
    ...
    var processNextAction_1 = function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentRunningTestState,
          currentActionIndex,
          currentAction,
          isLastAction,
          actionRunner,
          ...
          switch (_b.label) {
            case 0:
              ...
              if (
                ...
                throw new Error(
                  "processNextAction called when not in running state."
                );
              }
              currentActionIndex =
                currentRunningTestState.status.currentActionIndex;
              ...
              currentAction =
                currentRunningTestState.actions[currentActionIndex];
              isLastAction =
                currentActionIndex ===
                currentRunningTestState.actions.length - 1;
              actionRunner = actionRunners_1.find(function (actionRunner) {
                return currentAction.id === actionRunner.id;
              });
              if (!actionRunner) {
                failAtCurrentAction_1(
                  "No action runner found for action with id ".concat(
                    currentAction.id,
                    "."
                  )
                );
                ...
                if (
                  ...
                  console.log(
                    'Setting default value for "'
                      .concat(
                        (_a = actionArg.label) !== null && _a !== void 0
                          ? _a
                          : actionArg.id,
                        '", set to: '
                      )
                      .concat(actionArg.defaultValue)
                  );
              ...
              waitForURLToBe =
                currentRunningTestState.status
                  .onlyRunNextActionAfterURLPathBecomes ||
                currentAction.argsData[
                  makeNativeAdvancedArgIdWithPrefix("waitForURLToBe")
                ];
              pathWithoutDomain = window.location.href.substring(
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                wait_1(currentRunningTestState.delayBetweenActionsInMS),
              ];
            case 2:
              _b.sent();
              setTimeout(function () {
                if (!timeoutState.didFinish) {
                  ...
                  failAtCurrentAction_1(
                    "Action timed out after ".concat(
                      Math.round(currentAction.maxDurationInMS / 1000),
                      " seconds."
                    )
                  );
                }
            ...
            case 3:
              result = _b.sent();
              currentRunningTestState.globals = __assign(
                __assign({}, currentRunningTestState.globals),
                result && result.moreGlobalVars ? result.moreGlobalVars : {}
              );
              actionGenerators = (0, flattenArray_1.flattenArray)(
                actionRunners_1.map(function (runner) {
                  return runner.actionGenerators || [];
                })
              );
              if (
                ...
                actionRunnerIdsToRunners_1 = actionRunners_1.reduce(function (
                  acc,
                  curr
                ) {
                  acc[curr.id] = curr;
                ...
                {});
                for (
                  _i = 0, actionGenerators_1 = actionGenerators;
                  _i < actionGenerators_1.length;
                  _i++
                ) {
                  generator = actionGenerators_1[_i];
                  generatedActions = generator(currentRunningTestState.globals);
                  (_a = modifiersResult.generatedActions).push.apply(
                    _a,
                    (generatedActions || []).map(function (generatedAction) {
                      var _a;
                      ...
                      return {
                        ...
                        generatedActionLabel:
                          generatedAction.generatedActionLabel,
                        argsData: generatedAction.argsData,
                        requiresOneOf:
                          (_a = actionRunner.requiresOneOf) !== null &&
                          _a !== void 0
                            ? _a
                            : null,
                      };
              ...
              if (
                (mostRecentTestState === null || mostRecentTestState === void 0
                  ? void 0
